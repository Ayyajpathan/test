...
<CardGroup>
     ...
     <Card border="dark" style={{ width: '15rem' , height:'33rem'}}>
           ...
           <Card border="dark" style={{ width: '15rem' ,height:'33rem'}}>
             ...
             <Card.Body>
               <Card.Title>Society Maintenance Service</Card.Title>
               <Card.Text>
               Society Maintenance includes several tasks such as looking after maintenance collection, 
            maintaining records, checking for any issue with electricity or plumbing, power supply issues, 
            and other such routine tasks. It becomes difficult for a single person from society to manage such
             a large number of tasks daily. 
